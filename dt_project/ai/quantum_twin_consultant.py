...
# Define mock types in case imports fail
class DataType:
    pass
...
# Stub class for SpecializedDomain (with fallback attributes)
...
try:
    from ..quantum.specialized_quantum_domains import (
    ...
    specialized_domain_manager = None
...
try:
    ...
    universal_quantum_factory = None
